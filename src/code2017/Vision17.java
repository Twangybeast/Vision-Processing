...
public class Vision17 
{
	...
	public Target exec()
	{
		...
		image = new Dimension(image1.getWidth(), image2.getHeight());
		...
		if(particle == null)
		{
			fl.println("WARNING: No best particle found. Returning NULL target.");
			fl.close();
			return Target.getNullTarget();
		}
		Particle pair= pairParticles(particle, particles);
		this.pair=pair;
		if(pair==null)
		{
			return Target.getNullTarget();
	...
	public static Particle pairParticles(Particle particle, ArrayList<Particle> particles)
	{
		Particle pair=null;
